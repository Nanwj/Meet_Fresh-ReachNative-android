...
export default class BuyerQuickPayPage1 extends Component {

    constructor(props) {
        super(props);
        const {UserID, data, address} = this.props.route.params;
        this.state = {
            UserID: UserID,
            data: data,
            address: address,
    ...
    UNSAFE_componentWillMount() {
        const total = this.state.data.reduce((pre, item) => {
    ...
    render() {
        ...
        const {data, total, address, UserID} = this.state;
                    ...
                    <TouchableOpacity style={styles.paymentButton} onPress={
                        () => {
                            this.props.navigation.navigate(
                                'DeliveryMode',
                                {
                                    address, data, UserID, Type: 'Quick'
                                }
                            )
                        }
                    }>
