...
// change the state of QUICK order into posted
const alreadyPostedOrder = (order) => {
    // console.log("Confirm upload: ", order);
}

export default class QuickParcelPostage extends Component {

    constructor(props) {
        super(props);
        const {quickParcelList} = this.props;
        this.state = {
            quickParcelList: quickParcelList
        }
    }
    ...
    render() {
        ...
        const {quickParcelList} = this.state
